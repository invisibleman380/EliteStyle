...
<?php endif; ?>
		...
		<p><?php _e( 'Please login to retrieve your account settings and bookings.', 'woocommerce' ); ?></p>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<p><?php _e( 'Please register to create your ELITE STYLE account.', 'woocommerce' ); ?></p>
